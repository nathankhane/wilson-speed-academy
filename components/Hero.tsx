...
const Hero = () => {
    return (
        <section className="relative flex flex-col items-center justify-center min-h-[calc(100dvh-4rem)] text-center px-4 sm:px-6 lg:px-8 overflow-hidden bg-background">
            {/* Content */}
            ...
            >
                <span className="text-sm tracking-wide opacity-70 group-hover:opacity-100 transition-opacity text-muted-foreground">
                    Learn More
                </span>
                <ChevronDown className="w-5 h-5 animate-bounce-slow text-muted-foreground" />
            </a>
